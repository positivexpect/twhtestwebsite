  ...
  const locations = [
    {
      ...
      territory: 'Main (HQ)',
      franchiseOwner: 'Josh Zabec',
      franchiseOwnerId: 'user-hq',
      staff: 12,
      totalLeads: 287,
      status: 'active',
    ...
    },
    {
      ...
      slug: 'nova-va',
      territory: 'Nova Territory',
      franchiseOwner: 'Nova Operations',
      franchiseOwnerId: 'user-nova',
      staff: 8,
      totalLeads: 156,
      status: 'active',
    ...
    },
    {
      ...
      name: 'Florida',
      slug: 'florida',
      territory: 'Florida Territory',
      franchiseOwner: 'TBD',
      franchiseOwnerId: 'user-fl',
      staff: 0,
      totalLeads: 0,
      status: 'planned',
